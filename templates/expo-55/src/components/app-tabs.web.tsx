...
export default function AppTabs(): React.ReactNode {
  return (
    <Tabs>
...
export function TabButton({children, isFocused, ...props}: TabTriggerSlotProps): React.ReactNode {
  return (
...
export function CustomTabList(props: TabListProps): React.ReactNode {
